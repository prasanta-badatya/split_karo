      ...
      <ng-container *ngIf="!isLoading() && groups().length > 0">
        <div class="bg-slate-50 flex-1">
          <div class="max-w-6xl mx-auto px-4 sm:px-6 py-6">
            ...
            <!-- Desktop Table -->
            <div class="hidden md:block bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden anim-fade-up anim-d2">
            ...
            <!-- Mobile List -->
            <div class="md:hidden space-y-2 anim-fade-up anim-d2">
